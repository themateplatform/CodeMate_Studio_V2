...
<html lang="en">
  <head>
    ...
    <title>BuildMate Generated App</title>
  </head>
  <body>
    <div id="root"></div>
...
describe('App', () => {
  it('renders without crashing', () => {
    render(<App />)
    expect(screen.getByText(/BuildMate Generated App/i)).toBeInTheDocument()
  })
})
`;
}
...
function generateReadme(): string {
  return `# BuildMate Generated Application

This application was generated by BuildMate Studio.
